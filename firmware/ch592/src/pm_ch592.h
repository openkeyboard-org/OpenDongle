 ...
 * Plain byte stores from every context; cleared only at the top of
 * Main_Circulation. */
...
/* One idle attempt at the end of a Main_Circulation iteration. entry_work is
 * the dongle_pm_post value captured before the loop-top clear. */
